...
public class EliteDisintegratorRenderer<T extends EliteDisintegratorBlockEntity> implements BlockEntityRenderer<T> {

    public static BakedModel BLADE = null;


    public EliteDisintegratorRenderer(BlockEntityRendererProvider.Context context) {
    }

...
public class AdvancedDisintegratorRenderer<T extends AdvancedDisintegratorBlockEntity> implements BlockEntityRenderer<T> {

    public static BakedModel BLADE = null;


    public AdvancedDisintegratorRenderer(BlockEntityRendererProvider.Context context) {
    }

...
public class EliteDisintegratorAddon extends BasicScreenAddon {

    private final EliteDisintegratorBlockEntity blockEntity;

    public EliteDisintegratorAddon(int posX, int posY, EliteDisintegratorBlockEntity blockEntity) {
        super(posX, posY);

...
public class EliteReplicatorCraftingAddon extends BasicScreenAddon {

    private final EliteReplicatorBlockEntity blockEntity;

    public EliteReplicatorCraftingAddon(int posX, int posY, EliteReplicatorBlockEntity blockEntity) {
        super(posX, posY);
